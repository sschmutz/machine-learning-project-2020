...
```{r word-frequencies, fig.cap="\\label{fig:frequent-words}Word frequencies in title and teaser per source (not including stop words)", out.width = "80%", fig.align = "center"}
